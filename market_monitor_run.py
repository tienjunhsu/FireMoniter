...
class there_global(object):
    ...
    def get(self):
        return {'time_stamp':self.str_time,'sz50':self.sz50,'hs300':self.hs300,'zz500':self.zz500,'strategy':self.strategy}
...
def mWSQCallback(indata, *args, **kwargs):
    ...
    now_tick.str_time = d_time.strftime('%Y-%m-%d %H:%M:%S')
...
if __name__ == '__main__':
    ...
    scheduler.add_job(start_w,'cron',day_of_week = '0-4',hour=9,minute=39,second=20)
